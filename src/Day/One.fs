...
*)
    ...
    (*
  G Elves = {e| e is an elf, and e is Go until Fuel Counter-Upper}
  U SumOfFuelRequirementsForAllModules = ?
  E ModuleFuel = Floor(mass / 3) - 2
*)
...
33583 + 11192 + 3728 + 1240 + 411 + 135 + 43 + 12 + 2 = 50346.
  ...
  mass of the added fuel? (Calculate the fuel requirements for each module separately,
